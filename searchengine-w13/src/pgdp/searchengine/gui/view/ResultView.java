 ...
 * 1. alle bisher vom Result Controller geladenen Ergebnisse der letzten
 * Suchanfrage untereinander in Form von ResultPane-Objekten 2. darunter noch
 * einen Button zum Laden weiterer Dokumente an.
 */
public class ResultView extends JScrollPane {
	...
	/**
	 * Fügt das übergebene ResultPane-Objekt unten an die bereits vorhandenen an und
	 * updatet dann die Anzeige (mit einem Call der Methode 'updateUI()').
	 */
	...
	/**
	 * Löscht alle angezeigten ResultPane-Objekte aus der View (nicht aber den
	 * Load-More-Button).
	 */
	public void clear() {
